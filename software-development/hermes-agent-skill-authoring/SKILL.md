...
1. **Research first, write second** — When creating skills about tools/techniques, ALWAYS use `web_search`, `browser`, or `terminal` to check current GitHub repos for latest versions and commands. Do NOT write purely from training data — tools change fast. Training data is a starting point; live verification is mandatory.
